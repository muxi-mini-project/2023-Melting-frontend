    ...
    <View>
        <ScrollView className='selectedTagBox' scrollY='true' style={{display:props.model=='show'?"":"none"}}>
            <View >
                ...
                <View ><Input value={Inputvalue} className='tag' placeholder='+自定义' maxlength='8' onInput={(e)=>setInputvalue(e.detail.value)} onBlur={addSelf} style={{width:'80px'}}></Input></View>
            </View>
        </ScrollView>
