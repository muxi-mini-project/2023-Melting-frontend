...
export default function Introduction(){
  ...
  return(
        <View className='page'>
          ...
          <Image className='btnright' src={require('../../image/introduction/preview.png')} onClick={()=>{Taro.navigateTo({url:`/pages/introduction/details/preview/preview?project=${project}`})}} />
