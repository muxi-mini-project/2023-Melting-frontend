...
export default function Login() {
    ...
    // userInfo[1]?Taro.setStorageSync('url',userInfo[1]):''
    // realName?Taro.setStorageSync('nickName',realName):''
              ...
              <View className='popbutton'>
                <View >
                    <Button   
                          ...
                          // onGetUserInfo={Taro.getUserInfo()}
                          onClick={()=>{
                            // setchange(false)
                            Taro.getUserInfo({
                              desc: '用于完善会员资料',
                                success: function(res) {
                                  ...
                                  // console.log('url:',Info.avatarUrl);
